...
export default function ChefMenu() {
    ...
    const handleAddToOrder = (item) => {
        ...
        if (!item.is_available) {
            Alert.alert('Not Available', 'This dish is currently unavailable.');
            return;
        }
        logAppEvent({
            token: token,
                                ...
                                <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: 16, paddingBottom: 24 }}>
                                    ...
                                    <View style={st.modalSection}>
                                        ...
                                        <View style={st.stepperGroup}>
                                            ...
                                            <View style={st.stepperDivider} />
                                            <Stepper label="Minute" value={String(selectedMinute).padStart(2, '0')} onDecrement={handleMinDec} onIncrement={handleMinInc} />
                                        </View>
                                    </View>
                    ...
                    <View style={st.modalOverlay}>
                        <View style={st.modalCard}>
                            <View style={{ padding: 24, alignItems: 'center' }}>
                                ...
                                <Text style={[st.modalTxt, { textAlign: 'center', marginTop: 10 }]}>
                                    Create an account to add dishes to your cart and book a chef.
                                </Text>

                                <TouchableOpacity
                                    style={[st.placeOrderBtn, { width: '100%' }]}
                                    onPress={() => {
                                        setShowCreateAccountModal(false);
                                        router.push('/SignUpScreen');
                                    }}
                                >
                                    <Text style={st.placeOrderBtnTxt}>
                                        Create Account
                                    </Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    style={[st.returnBtn, { width: '100%', marginTop: 10 }]}
                                    onPress={() => setShowCreateAccountModal(false)}
                                >
                                    <Text style={st.returnBtnTxt}>
                                        Continue Browsing
                                    </Text>
                                </TouchableOpacity>
                            </View>
